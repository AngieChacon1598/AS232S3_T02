    ...
    <div class="hero-section section">
        ...
        <div class="hero-slider hero-slider-one fix">
            ...
            <div class="hero-item"
                ...
                <div class="hero-content">
                    <h1>Experiencias culinarias que enamoran </h1>
                ...
                <div class="col-xl-6 col-lg-5 col-12 mb-40">
                    ...
                    <div class="row">
                        <div class="section-title text-start col mb-30">
                            <h1>Los Pinos</h1>
                            <p>Restaurante tradicional Cañetano</p>
                        </div>
                    </div>
                    ...
                    <div class="row mbn-40">
                        ...
                        <div class="col-12 mb-40">
                            <div class="testimonial-item">
                                <p>Tenemos los mejores menús criollos de Cañete y una amplia variedad de comidas marinas; el
                                    ceviche peruano, mostrito, parrillas, aguadito, así como nuestras bebidas y postres
                                    emblema.
                                    Ven y disfruta de un rico menú criollo, comida tradicional de
                                    siempre.</p>
                            </div>
                        </div>
                    ...
                    <div class="row mbn-40">
                        ...
                        <div class="col-12 mb-40">
                            <div class="blog-item">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Ambiente acogedor</a></h4>
                                    <div class="desc">
